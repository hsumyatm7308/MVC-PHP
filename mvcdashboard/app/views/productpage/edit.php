...
<div class="w-full text-black  flex justify-between items-center p-10 mb-5">
    <div>
        <div>
            <h1 class="text-2xl">New Product | Edit</h1>
        </div>
    ...
    <div class="space-x-3">
        <span class="text-slate-500 bg-slate-200  transition-all duration-300  hover:bg-teal-600 rounded-md px-4 py-2 ">
...
<div class="w-full px-10">
    <form id="form" action="" method="">
        ...
        <div class="w-full md:grid md:grid-cols-4 gap-10">
            <div class="col-span-3 w-full bg-slate-200 rounded-md px-10 py-10 ">
            ...
            <div class="col-span-3 w-full rounded-md py-10 ">
                ...
                <div class="w-full md:grid md:grid-cols-3 gap-10">
                    ...
                    <div class="col-span-2 md:mt-0 mt-5 otherdetails_container_right">
                        ...
                        <div class="bg-slate-200 rounded-md px-10 py-10 space-y-5 hidden otherdetails_element_right">
